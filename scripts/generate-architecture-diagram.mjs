...
function buildSvg({ title, version, environment, features, roadmap }) {
  const nodes = [
    {
      id: "ui",
      label: "Workbench + CLI/TUI",
      detail: "浏览器工作台 / CLI / 全屏 TUI",
      x: 70,
      y: 170,
      w: 260,
      h: 92,
    ...
    {
      id: "tools",
      label: "Tool Policy + Read Tools",
      detail: "allowlist / budget clamp / approval metadata",
      x: 430,
      y: 345,
      w: 260,
      h: 92,
    ...
    },
    {
      ...
      detail: ".agent-runs / resume context / docs SVG",
      x: 70,
      y: 535,
      w: 360,
      h: 92,
